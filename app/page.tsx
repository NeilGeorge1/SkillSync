...
export default function Home() {
  return (
    <div>
      <Navbar /> 
      {/* Hero Section */}
      <div className="hero  width-100 sm:width-500 md: lg:mt-10 max-h-screen">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="feature-card p-6 bg-gray-900 rounded-lg">
              <h3 className="text-2xl font-semibold text-white">Skill Matching</h3>
              <p className="mt-4 text-gray-400">
                Our recommender system intelligently matches students with mentors
                who have the right skills to help them grow.
              </p>
            </div>
            <div className="feature-card p-6 bg-gray-900 rounded-lg">
              <h3 className="text-2xl font-semibold text-white">Collaborative Projects</h3>
              <p className="mt-4 text-gray-400">
                Work on real-world projects that challenge your skills and give you
                hands-on experience. Collaborate and build something impactful.
              </p>
            </div>
            <div className="feature-card p-6 bg-gray-900 rounded-lg">
              <h3 className="text-2xl font-semibold text-white">Feedback System</h3>
              <p className="mt-4 text-gray-400">
